...
public class NewOrderMain {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        String message = "123467,5312156,3321.53";
        // For this simple test we will be using the same value for key and value
        ProducerRecord<String, String> record = new ProducerRecord<>(ECOMMERCE_TOPIC, message, message);
        ...
        var emailRecord = new ProducerRecord<>(ECOMMERCE_TOPIC_SEND_EMAIL, email, email);
